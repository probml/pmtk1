...
% This function is effectively a wrapper around the standard lars implementation. 
% The only major difference is that it returns weights corresponding to specific
