...
global_options.TolFun = 1e-9;

if 0 % Exact Hessian Variants
...
%     options{i} = global_options;
%     options{i}.solver = 'SPG';
%     i = i + 1;
elseif 0 % quasi-Newton variants
...
%         options{i} = global_options;
%     options{i}.Solver = 'schur';
%     options{i}.Hessian = 'sr1';
%     i = i + 1;
%     
%             options{i} = global_options;
%     options{i}.Solver = 'schur';
%     options{i}.Hessian = 'lbfgs';
%     i = i + 1;
%     
%                 options{i} = global_options;
%     options{i}.Solver = 'schur';
%     options{i}.Hessian = 'lsr1';
%     i = i + 1;
    %
    % options{i} = global_options;
    % options{i}.solver = 'steihaug';
