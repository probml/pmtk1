%% penalized linear regression on the Prostate Data Set
...
modelL1shooting2 = fit(LinregL1(lambda, '-transformer', T, '-method', 'shooting'), Xtrain, ytrain);
assert(approxeq(modelL1shooting.w, modelL1shooting2.w))
yp2 = predict(modelL1shooting2,Xtest);
assert(approxeq(yp, yp2))
...
modelL1lars2 = fit(LinregL1(lambda, '-transformer', T, '-method', 'lars'), Xtrain, ytrain);
assert(approxeq(modelL1lars.w, modelL1lars2.w))
yp2 = predict(modelL1lars2,Xtest);
L1larsErr2 = mse(ytest,mode(yp2));
assert(approxeq(L1larsErr, L1larsErr2))
%}
...
modelL2qr2 = fit(LinregL2(lambda, '-transformer', T, '-method', 'ridgeQR'), Xtrain, ytrain);
assert(approxeq(modelL2qr.w, modelL2qr2.w))
