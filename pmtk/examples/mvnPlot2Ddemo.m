...
if doPrintPmtk, doPrintPmtkFigures('gaussPlot2dDemoSurfFull'); end;
figure; plot(MvnDist(mu,S), 'xrange', [-6 6 -6 6], 'useContour', true); title('full');
if doPrintPmtk, doPrintPmtkFigures('gaussPlot2dDemoContourFull'); end;
[U,D] = eig(S);
% Decorrelate
S1 = U'*S*U
figure; plot(MvnDist(mu,S1), 'xrange', [-5 5 -10 10], 'useContour', false); title('diagonal')
if doPrintPmtk, doPrintPmtkFigures('gaussPlot2dDemoSurfDiag'); end;
figure; plot(MvnDist(mu,S1), 'xrange', [-5 5 -10 10], 'useContour', true); title('diagonal');
if doPrintPmtk, doPrintPmtkFigures('gaussPlot2dDemoContourDiag'); end;
...
if doPrintPmtk, doPrintPmtkFigures('gaussPlot2dDemoSurfSpherical'); end;
figure; plot(MvnDist(mu,S2), 'xrange', [-5 5 -5 5], 'useContour', true);
title('spherical');axis('equal');
if doPrintPmtk, doPrintPmtkFigures('gaussPlot2dDemoContourSpherical'); end;