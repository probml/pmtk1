...
%A
annotation(gcf,'textbox',[0.3822 0.74 0.06254 0.08795],'String',{'A'},...
    'FontSize',24,...
    'FitBoxToText','off',...
    'LineStyle','none',...
    'Color',[1 0 0]);
...
% B
annotation(gcf,'textbox',[0.4837 0.66 0.06254 0.08795],'String',{'B'},...
    'FontSize',24,...
    'FitBoxToText','off',...
    'LineStyle','none',...
    'Color',[0 0 1]);
...
% AUC
annotation(gcf,'textbox',[0.45 0.25 0.104 0.1205],'String',{'AUC'},...
    'FontSize',24,...
    'FitBoxToText','off',...
    'LineStyle','none',...
    'Color',[0 0 1]);
