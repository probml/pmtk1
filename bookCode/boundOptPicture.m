...
box on;
set(gca,'XTick',[],'YTick',[]);
legend([p1,p2,p3],{'Q(\theta|\theta^k)','Q(\theta|\theta^{k+1})','f(\theta)'},'Location','NorthWest','FontSize',14);
...
%annotation(gcf,'line',[0.3 0.3],[0.5146 0.1108],'LineStyle',':');
...
% Create textbox % [0.4185 0.02411 0.08859 0.1012]
