...
annotate;
    ...
    function plot2d        
        ...
        contour('Parent',mainAx,x,y,p,'r','LineWidth',2,'LevelList',[4 11 15]); 
    ...
    function plotMarginal
        fmarge = @(x)normpdf(x,mu(1),sigma(2,2));
    ...
    function plotConditional
        ...
        fcond = @(x)normpdf(x,mu_cond,sigma_cond);
    ...
    function annotate
        annotation(fig,'arrow',[0.8938 0.8938],[0.8904 0.387],'LineWidth',2);
        annotation(fig,'textbox','String',{'\Sigma'},'FontSize',30,'FitBoxToText','off','LineStyle','none','Position',[0.82 0.4991 0.03025 0.07531]);
        annotation(fig,'line',[0.4382 0.4382],[0.8571 0.373],'LineStyle',':');
        annotation(fig,'textbox','String',{'X_0'},'FontSize',14,'FitBoxToText','off','LineStyle','none','Position',[0.4274 0.8704 0.02331 0.04904]);
        annotation(fig,'arrow',[0.4306 0.3125],[0.8501 0.8529],'LineWidth',2);
    end
